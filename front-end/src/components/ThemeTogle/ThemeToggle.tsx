...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2.5 bg-surface-secondary hover:bg-surface-hover border border-system-border-subtle rounded-xl text-system-text-primary transition-all flex items-center justify-center group shadow-lg"
